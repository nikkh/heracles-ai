...
namespace Thessaloniki.Controllers
{
    ...
    [ApiController]
    public class DiomedesController : ControllerBase
    {
        private readonly ILogger _logger;
        private readonly TelemetryClient _telemetryClient;
        private readonly IConfiguration _configuration;

        public DiomedesController(ILogger<DiomedesController> logger, TelemetryClient telemetryClient, IConfiguration configuration)
        {
            _logger = logger;
        ...
        {
            const string controllerName = "mares-of-diomedes";
