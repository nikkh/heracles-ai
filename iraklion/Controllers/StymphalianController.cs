...
namespace Iraklion.Controllers
{
    ...
    [ApiController]
    public class StymphalianController : ControllerBase
    {
        ...
        public StymphalianController(ILogger<StymphalianController> logger, TelemetryClient telemetryClient, IConfiguration configuration, ServiceBusSender serviceBusSender)
        {
            _logger = logger;
        ...
        {
            const string controllerName = "stymphalian-birds";
            ...
            var payload = $"This is a message sent from Stymphalian on {System.DateTime.Now.ToShortDateString()} at {System.DateTime.Now.ToLongTimeString()}.  TraceGuid={traceGuid}";
            var messageModel = new MessageModel();
            messageModel.Payload = payload;
            messageModel.TraceGuid = traceGuid;
            messageModel.Queue = "patra-queue";
