...
namespace Iraklion.Controllers
{
    ...
    [ApiController]
    public class CretanController : ControllerBase
    {
        ...
        public CretanController(ILogger<CretanController> logger, TelemetryClient telemetryClient, IConfiguration configuration, ServiceBusSender serviceBusSender)
        {
            _logger = logger;
        ...
        {
            const string controllerName = "cretan-bull";
            ...
            var payload = $"This is a message sent from cretan-bull on {System.DateTime.Now.ToShortDateString()} at {System.DateTime.Now.ToLongTimeString()}.  TraceGuid={traceGuid}";
            var messageModel = new MessageModel();
            messageModel.Payload = payload;
            messageModel.TraceGuid = traceGuid;
            messageModel.Queue = "ioannina-queue";
